 ...
 * Name:    main_message_task.c

 * Purpose: display a message depending on a tasks priority 
...
//  below the fuction declaration necessary for conpile
//  You can select the fuction in FreeRTOSConfing.h file
